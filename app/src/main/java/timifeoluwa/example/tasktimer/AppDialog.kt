...
//        fun onDialogCancelled(dialogId: Int)
    ...
    override fun onAttach(context: Context) {
        ...
        dialogEvents = try {
            //Is there a parent fragment? if so, that will be what it will call back.
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val arguments = arguments   //we'll be passing the information or message we want to display in the arguments bundle.
        val dialogId: Int
        val messagesString: String?
        var positiveStringId: Int
        var negativeStringId: Int
        /**
         * Retrieving the bundle that was created when the dialogFragment was created and extracting the values from it using the constants.
         */
        if (arguments != null) {
            dialogId = arguments.getInt(DIALOG_ID)
            messagesString = arguments.getString(DIALOG_MESSAGE)
            ...
            //if the text for the buttons are not provided, the set the default to ok and cancel.
        ...
        return builder.setMessage(messagesString)
